...
var index_1 = index$1.object;
var index_2 = index$1.oneOfType;
var index_3 = index$1.string;
var index_4 = index$1.node;
var index_5 = index$1.func;
var index_6 = index$1.bool;
    ...
    for (; i < pathArray.length - 1; i++) {
        ...
        if (resVal[currentPath]) {
            ...
            resVal = resVal[currentPath] = Array.isArray(currentObj)
                ? currentObj.slice() : __assign({}, currentObj);
        }
        else {
...
var Field = function (_a, context) {
    ...
    return React.createElement(component, __assign({}, props, bag));
};
Field.contextTypes = {
    formik: index_1,
};
...
var Formik = (function (_super) {
    ...
    function Formik(props) {
        ...
        _this.handleChange = function (e) {
            ...
            if (_this.props.validateOnChange) {
                _this.runValidations(setDeep(field, value, _this.state.values));
            }
        };
        _this.handleChangeValue = function (field, value) {
            ...
            _this.setState(function (prevState) { return (__assign({}, prevState, { values: setDeep(field, value, prevState.values), touched: setDeep(field, true, prevState.touched) })); });
            _this.runValidationSchema(setDeep(field, value, _this.state.values));
        };
    ...
    Formik.prototype.componentWillReceiveProps = function (nextProps) {
        if (this.props.enableReinitialize &&
            !index$3(nextProps.initialValues, this.props.initialValues)) {
...
function setNestedObjectValues(object, value, response) {
